...
OneComp is an open-source Python library for post-training quantization of Large Language Models (LLMs).
...
- **Multi-GPU support** -- Distribute layer-wise quantization across multiple GPUs
...
OneComp is released under the terms of the [LICENSE](https://github.com/fujitsu/onecomp/blob/main/LICENSE) file included in the repository.
